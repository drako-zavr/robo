<template>
    <q-header reveal class="navbar bg-secondary">
        <q-toolbar class="q-container bg-transparent q-pa-md">
            ...
            <!-- <img src="../assets/images/menu.png"  class="navbar__menu-btn" alt=""> -->
            <a id="nav1" class="navbar__link" href="#school"> О школе </a>
            <a id="nav2" class="navbar__link" href="#teachers"> Тренеры </a>
            ...
            <!-- <q-btn padding="10px"  class="navbar__menu-btn"></q-btn>
            <q-btn icon="../assets/images/menu.png" class="navbar__menu-btn" @click="dialog = true"></q-btn> -->
        ...
        <q-dialog v-model="dialog" class="modal">
            <!-- <q-btn class="navbar__close-btn" v-close-popup></q-btn> -->
